...
Class ValueHelpers
{
	...
	*/
	public static function getRoleValue($role_name)
	{
		...
		$sql = "SELECT role_value FROM crm_role WHERE role_name=:role_name";
	...
	*/
	...
	{
		$connection = \Yii::$app->db;
		$sql = "SELECT status_value FROM crm_status WHERE status_name=:status_name";
		$command = $connection->createCommand($sql);
	...
	*/
	public static function getUserTypeValue($user_type_name)
		{
		$connection = \Yii::$app->db;
		$sql = "SELECT user_type_value FROM crm_user_type
